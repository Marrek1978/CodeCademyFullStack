...
import { SmlButton } from "../buttons/Buttons";
...
function ProductCard({
  ...
  return (
    <>
      <div className="card card-compact max-w-sm  shadow-xl p-0 bg-white justify-center">
        <figure>
          <img src={imagePath} alt="skis" className="h-56 max-h-72 object-cover" />
        </figure>
